...
<div class="container-fluid px-4">
            ...
            <div class="card mt-4 shadow">
                  ...
                  <div class="col-md-12 mb-3">
                        ...
                        <textarea name="description" required class="form-control" rows="3" > <?= $category['data']['description']; ?></textarea>      
                  </div>
                  ...
                  <div class="col-md-6 mb-3">
                       <button type="submit" name="updateCategory" class="btn btn-primary"> Save
