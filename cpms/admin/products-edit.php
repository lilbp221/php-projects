...
<div class="container-fluid px-4">
            ...
            <div class="card mt-4 shadow">
                  ...
                  <div class="col-md-4 mb-3">
                        ...
                        <input type="text"  name="price" required value="<?= $product['data']['price']?>" class="form-control" rows="3" />  
                  </div>
                  <div class="col-md-4 mb-3">
                        <label for=""> Quantity *</label>
                        
                        <input type="text"  name="quantity" required value="<?= $product['data']['quantity']; ?>"class="form-control" rows="3" />     
                  </div>
                  <div class="col-md-4  mb-3">
